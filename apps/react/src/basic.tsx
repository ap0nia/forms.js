...
import type { NestedValue, ValidationMode } from '@hookform/react'
...
export function Basic() {
  ...
  return (
    ...
    >
      <input placeholder="nest.nest1" {...register('nestItem.nest1', { required: true })} />
      ...
      <input type="number" {...register('max', { max: 20 })} placeholder="max" />
      {errors.max && <p>max error</p>}
      <input type="date" {...register('minDate', { min: '2019-08-01' })} placeholder="minDate" />
      {errors.minDate && <p>minDate error</p>}
      <input type="date" {...register('maxDate', { max: '2019-08-01' })} placeholder="maxDate" />
      {errors.maxDate && <p>maxDate error</p>}
      <input {...register('minLength', { minLength: 2 })} placeholder="minLength" />
      ...
      <input {...register('pattern', { pattern: /\d+/ })} placeholder="pattern" />
      ...
      Radio3
      <input type="radio" value="3" {...register('radio', { required: true })} />
      {errors.radio && <p>radio error</p>}
      <input type="checkbox" {...register('checkbox', { required: true })} />
      {errors.checkbox && <p>checkbox error</p>}
      <input type="checkbox" value="1" {...register('checkboxArray', { required: true })} />
      <input type="checkbox" value="2" {...register('checkboxArray', { required: true })} />
      <input type="checkbox" value="3" {...register('checkboxArray', { required: true })} />
