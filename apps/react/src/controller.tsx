import { useForm, Controller as FormController } from '@hookform/react'
      ...
      <div className="container">
        ...
        <section id="input-switch">
          ...
          <FormController
            ...
            rules={{ required: true }}
            render={({ field: props }) => (
              <Switch {...props} onChange={(e) => props.onChange(e.target.checked)} />
            )}
            control={control}
          />
        </section>
        ...
        <section id="input-ReactSelect">
          ...
          <FormController
            render={({ field }) => <PureReactSelect isClearable options={options} {...field} />}
            name="ReactSelect"
            control={control}
            rules={{ required: true }}
          />
