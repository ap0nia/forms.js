...
import type { NestedValue } from '@hookform/react'
...
export function SetValue() {
  ...
  return (
    <form onSubmit={handleSubmit(() => {})}>
      ...
      <input {...register('object.middleName')} placeholder="object.middleName" />
      ...
      <input {...register('trigger', { required: true })} placeholder="trigger" />
      {errors.trigger && <p id="trigger">Trigger error</p>}

      <input {...register('nestedValue', { required: 'required' })} placeholder="nestedValue" />
