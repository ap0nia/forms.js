...
export function ValidateFieldCriteria() {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <input {...register('firstName', { required: true, minLength: 4 })} placeholder="firstName" />
      ...
      />
      {errors.validate && errors.validate.types && errors.validate.types.test && (
        <p>validate test</p>
      )}
