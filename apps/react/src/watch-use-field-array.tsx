import { useForm, useFieldArray } from '@hookform/react'
...
export function WatchUseFieldArray() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <button id="append" type="button" onClick={() => append({ name: renderCount.toString() })}>
        append
      </button>

      <button id="prepend" type="button" onClick={() => prepend({ name: renderCount.toString() })}>
        prepend
      </button>

      <button id="update" type="button" onClick={() => update(3, { name: 'updated value' })}>
        append
      </button>
      ...
      <button id="insert" type="button" onClick={() => insert(1, { name: renderCount.toString() })}>
        insert
      </button>
