...
describe('unset', () => {
  ...
  describe('when there are remaining props', () => {
    it('should not unset the array', () => {
      ...
      // @ts-expect-error Setting new property.
      test.test.root = {
        test: 'message',
      }
      ...
      // @ts-expect-error Seting new property.
  ...
  describe('in presence of Array polyfills', () => {
    beforeAll(() => {
      // @ts-expect-error Setting a custom property on the Array prototype.
    ...
    afterAll(() => {
      // @ts-expect-error Remove the custom property on the Array prototype.
