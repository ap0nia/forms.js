import { INPUT_EVENTS, VALIDATION_MODE, type SubmissionValidationMode } from '../constants'
...
import type {
  ErrorOption,
  FieldErrors,
  FieldErrorRecord as FieldErrorRecord,
} from '../types/errors'
...
> {
  ...
  > {
    ...
    if (this.options.resolver == null) {
      ...
      const names: any = nameArray ?? Array.from(this.names.mount)
