...
import { nativeValidateSingleField as validateField } from '../../../../src/logic/validation/native-validation'

/**
 * Completely unmodified version of tests from react-hook-form.
 */
describe('react-hook-form', () => {
  describe('validateField', () => {
    it('should return required true when input not filled with required', async () => {
      ...
      /**
       * @remarks Skipped because not sure how to replicate this Jest mock in Vitest...
       */
        ...
        await validateField(
          {
            _f: {
              ...
              value: 'This is a long text input',
              // @ts-expect-error Validate is supposed to be a function, not string.
              validate: 'validate',
            },
          },
