import type { SubmitHandler } from '@forms.js/core'
import {
  act,
  act as actComponent,
  fireEvent,
...
describe('initialize', () => {
  ...
  describe('when component unMount', () => {
    ...
    it('should remove reset method when field array is removed', () => {
      let controlTemp: Control<any> = undefined!
      ...
      expect(controlTemp.names.array).toEqual(new Set(['test']))
      expect(fieldsTemp).toEqual([
        { id: '0', value: 'default' },
        {
          id: '1',
...
it('should not populate defaultValue when field array is already mounted', async () => {
  ...
  expect((screen.getAllByRole('textbox')[3] as HTMLInputElement).value).toEqual('child of index 0')
})
