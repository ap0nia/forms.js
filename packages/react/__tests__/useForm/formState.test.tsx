...
describe('formState', () => {
  ...
  it('should be a proxy object that returns undefined for unknown properties', () => {
    ...
    // @ts-expect-error Property does not exist on the type level.
  ...
  it('should not update form state when there is a promise reject', async () => {
    const rejectPromiseFn = jest.fn().mockRejectedValue(new Error('this is an error'))
  ...
  /**
   * Issues with vitest and fake timers...
