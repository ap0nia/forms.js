...
describe('useWatch', () => {
  ...
  /**
   * @todo The `onChange` handler isn't called because it's the same value?
   */
  ...
  describe('fieldArray', () => {
    it.skip('should watch correct input update with single field array input', () => {
...
console.log('A', inputValues)
      fireEvent.click(screen.getAllByRole('button')[1])
console.log('G', inputValues)
