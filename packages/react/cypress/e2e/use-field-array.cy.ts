describe('useFieldArray', () => {
  it.only('should behaviour correctly without defaultValues', () => {
    cy.visit('/use-field-array/normal')
  ...
  it('should behaviour correctly with defaultValue', () => {
    cy.visit('/use-field-array/default')
    ...
    cy.get('#result').should(($state) =>
      expect(JSON.parse($state.text())).to.be.deep.equal({
        data: [{ name: 'test' }, { name: 'test1' }, { name: 'test2' }, { name: '2' }],
      }),
    )
  ...
  it('should behaviour correctly with defaultValue and without auto focus', () => {
    cy.visit('/use-field-array/defaultAndWithoutFocus')
  ...
  it('should display the correct dirty value with async default value', () => {
    cy.visit('/use-field-array/asyncReset')
    cy.get('#dirty').contains('no')
    cy.get('#field0').focus()
    cy.get('#field0').blur()
    cy.get('#dirty').contains('no')
  ...
  it('should return correct isValid formState', () => {
    cy.visit('/use-field-array/formState')
