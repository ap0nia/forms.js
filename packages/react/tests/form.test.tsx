...
import { describe, beforeAll, afterEach, afterAll, it, expect, vi as jest } from 'vitest'
...
const server = setupServer(
  rest.post('http://localhost:6969/success', (_, res: ResponseComposition, ctx: RestContext) => {
    return res(
      ctx.json({
        message: 'ok',
      }),
...
describe('Form', () => {
  ...
  it.only('should handle success request callback', async () => {
