import { render, renderHook, fireEvent, screen, waitFor } from '@testing-library/react'
...
describe('useWatch', () => {
  ...
  /**
   * @remarks Modified number of renders.
   */
  it('should return defaultValue with shouldUnregister set to true and keepDefaultValues', () => {
    ...
    expect(output).toEqual([{ test: 'test' }, { test: 'test' }, { test: 'test' }])
  })
  ...
  describe.todo('fieldArray with shouldUnregister true', () => {
  ...
  describe('reset', () => {
    ...
    describe.todo('with useFieldArray', () => {
